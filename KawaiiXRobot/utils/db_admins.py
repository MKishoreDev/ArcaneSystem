...
gbansdb = mdb.gban
coupledb = mdb.couple
captchadb = mdb.captcha
solved_captcha_db = mdb.solved_captcha
captcha_cachedb = mdb.captcha_cache
antiservicedb = mdb.antiservice
pmpermitdb = mdb.pmpermit
welcomedb = mdb.welcome_text
blacklist_filtersdb = mdb.blacklistFilters
pipesdb = mdb.pipes
sudoersdb = mdb.sudoers
blacklist_chatdb = mdb.blacklistChat
restart_stagedb = mdb.restart_stage
flood_toggle_db = mdb.flood_toggle
rssdb = mdb.rss
chatbotdb = mdb.chatbot
