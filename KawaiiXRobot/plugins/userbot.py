...
from KawaiiXRobot import ubot  # don't remove
from KawaiiXRobot import Inspector, USERBOT_PREFIX, app, arq, eor
from KawaiiXRobot.core.keyboard import ikb
from KawaiiXRobot.core.tasks import add_task, rm_task
