...
@bot.on_message(gen("delInspector"))
async def delInspector_handler(_, m: Message):
    ...
    if user_id in Inspector_list:
        ...
        bot.setdv("Inspector_USERS", " ".join(Inspector_list))
    else:
